...
export default function Home() {
  ...
  // 2) Gera PDF server-side e abre popup no mobile
  const generatePdf = async () => {
    setLoading(true);
    // abre janela em branco imediatamente (evita bloqueio de popup)
  ...
  const textareaStyle = {
    width: '100%', padding: 8, marginTop: 4, fontFamily: 'monospace'
  };
  ...
  return (
    <div style={{ padding:20, maxWidth:640, margin:'auto', fontFamily:'Arial, sans-serif' }}>
      ...
      <div style={{
        ...
        gap:16,
        /* em CSS real, use media queries; aqui é ilustrativo */
      }}>
        <label>
          Company Name
          <input
